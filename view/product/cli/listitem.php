...
?>
<link rel="stylesheet" href="view/product/cli/style.css">
  ...
  if (isset($products) && is_array($products)) {
    foreach ($products as $product) {
      ...
      <div class="card col-2 p-0 product-card" style="border-style: none;">
        <a href="index.php?controller=sanPham_view&id=<?php echo $product->id_pro; ?>" style="text-decoration: none; color: inherit;">
